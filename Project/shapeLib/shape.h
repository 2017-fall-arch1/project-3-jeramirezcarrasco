...
// this is the struct for the game map
typedef struct Abmap_s {
  void (*getBounds)(const struct AbRect_s *rect, const Vec2 *centerPos, Region *bounds);
  int (*check)(const struct AbRect_s *shape, const Vec2 *centerPos, const Vec2 *pixel);
  const Vec2 halfSize;	
} Abmap;
// this is the struct for double score 
typedef struct Abbak_s {
  void (*getBounds)(const struct AbRect_s *rect, const Vec2 *centerPos, Region *bounds);
  int (*check)(const struct AbRect_s *shape, const Vec2 *centerPos, const Vec2 *pixel);
  const Vec2 halfSize;	
} Abbak;
//and for triple score
typedef struct Abcat_s {
  void (*getBounds)(const struct AbRect_s *rect, const Vec2 *centerPos, Region *bounds);
  int (*check)(const struct AbRect_s *shape, const Vec2 *centerPos, const Vec2 *pixel);
  const Vec2 halfSize;	
} Abcat;
...
////////////////////////////////////////////////////////////////////////////////////////////
// this is part of the Abmap struct
////////////////////////////////////////////////////////////////////////////////////////////
void abRectGetBoundsm(const Abmap *rect, const Vec2 *centerPos, Region *bounds);

/** As required by AbShape
 */
int abRectCheckm(const Abmap *rect, const Vec2 *centerPos, const Vec2 *pixel);

typedef Abmap AbRectOutlinem;	/* same as AbRect */

/** As required by AbShape
 */
void abRectOutlineGetBoundsm(const Abmap *rect, const Vec2 *centerPos, Region *bounds);

/** As required by AbShape
 */
int abRectOutlineCheckm(const Abmap *rect, const Vec2 *centerPos, const Vec2 *pixel);

///////////////////////////////////////////////////////////////////////////////////////////////
//part of the struct for double points
///////////////////////////////////////////////////////////////////////////////////////////////
void abRectGetBoundsb(const Abbak *rect, const Vec2 *centerPos, Region *bounds);

/** As required by AbShape
 */
int abRectCheckb(const Abbak *rect, const Vec2 *centerPos, const Vec2 *pixel);

typedef Abbak AbRectOutlineb;	/* same as AbRect */

/** As required by AbShape
 */
void abRectOutlineGetBoundsb(const Abbak *rect, const Vec2 *centerPos, Region *bounds);

/** As required by AbShape
 */
int abRectOutlineCheckb(const Abbak *rect, const Vec2 *centerPos, const Vec2 *pixel);

////////////////////////////////////////////////////////////////////////////////////////////////
//part of the struct for triple score
////////////////////////////////////////////////////////////////////////////////////////////////
void abRectGetBoundsC(const Abcat *rect, const Vec2 *centerPos, Region *bounds);

/** As required by AbShape
 */
int abRectCheckC(const Abcat *rect, const Vec2 *centerPos, const Vec2 *pixel);

typedef Abcat AbRectOutlineC;	/* same as AbRect */

/** As required by AbShape
 */
void abRectOutlineGetBoundsC(const Abcat *rect, const Vec2 *centerPos, Region *bounds);

/** As required by AbShape
 */
int abRectOutlineCheckC(const Abcat *rect, const Vec2 *centerPos, const Vec2 *pixel);
